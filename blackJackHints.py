...
def play_game():
  ...
  def calculate_score(cards):
    '''
    this function takes an array of values(cards) and sums them together to return a score.
    '''
  ...
  while not is_game_over:
    ...
    print(f'Your cards : {user_cards}  Your score : {users_score}')
    ...
    if users_score == 0 or computers_score == 0 or users_score > 21 :
      ...
      draw_card = input('Do you want to draw another card? Type "y" for yes and "n" for no. : ')
      if draw_card == 'y' : 
        user_cards.append(deal_card())
  ...
  print(f'your final hand is {user_cards} and your final score was : {users_score}')
  print(f'the computers final had is {computer_cards} and the computers final score is {computers_score};')
